  ...
  d3.json("matrix.json", function(mat) {
    ...
    svg.append("svg:g")
       ...
       .append("title").text(function(d, i) {
         return neighs[i].name + ": " + (d.value).toFixed(0) + " percentage of total trains";
       });
...
function rerender(data) {
  ...
  svg.selectAll(".arc")
     ...
     .select("title").text(function(d, i) {
         return neighs[i].name + ": " +(d.value) + " of origins";
       });
